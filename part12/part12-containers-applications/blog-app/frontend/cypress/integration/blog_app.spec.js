describe('Blog app', function() {
  ...
  describe('When logged in', function() {
    ...
    it('A blog can be created', function() {
      ...
      cy.get('.bloglist')
        .contains('title created by cypress')
    })

    describe('When a blog is created', function() {
      beforeEach(function() {
        cy.createBlog({ title: 'testblog', author: 'tester', url: '/test/blog' })
      })
  ...
  describe('When multiple blogs created', function() {
    beforeEach(function() {
      cy.login({ username: 'testuser01', password: 'secretpassword' })
      cy.createBlog({ title: 'blog01', author: 'tester01', url: '/test/blog', likes: 11 })
      cy.login({ username: 'testuser02', password: 'password' })
      cy.createBlog({ title: 'blog02', author: 'tester02', url: '/test/blog', likes: 10 })
    })
